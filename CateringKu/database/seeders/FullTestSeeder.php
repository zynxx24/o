...
use App\Models\{User, Vendor, Category, MenuItem, Order, OrderItem, Payment, Review, Cart, CartItem, Promo, ContactMessage, Wallet, CommissionRule};
...
class FullTestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('order_commissions')->truncate();
        ...
        $vendorProfiles = [
            [
                ...
                'user' => 'vendor_nusantara',
                'email' => 'nusantara@cateringku.com',
                'city' => 'Jakarta',
            ...
            [
                'name' => 'Padang Bundo Catering',
                'user' => 'vendor_padang',
                'email' => 'padang@cateringku.com',
                'city' => 'Medan',
        ...
        $menuTemplates = [
            // vendor 0: Nusantara
            [
                ['Nasi Goreng Kampung', 25000, 'porsi', 0, 'sedang'],
                ['Ayam Bakar Madu', 35000, 'porsi', 0, 'tidak pedas'],
                ['Rendang Sapi', 45000, 'porsi', 0, 'pedas'],
                ['Soto Betawi', 30000, 'porsi', 0, 'tidak pedas'],
                ['Nasi Uduk Komplit', 28000, 'porsi', 0, 'tidak pedas'],
                ['Gado-Gado Jakarta', 22000, 'porsi', 0, 'tidak pedas'],
                ['Sate Ayam Madura', 30000, 'porsi', 7, 'sedang'],
                ['Nasi Tumpeng Mini', 85000, 'porsi', 5, 'tidak pedas'],
                ['Es Teh Manis', 8000, 'gelas', 4, 'tidak pedas'],
                ['Kue Lapis Legit', 15000, 'potong', 3, 'tidak pedas'],
                ['Snack Box Ekonomis', 18000, 'box', 2, 'tidak pedas'],
                ['Rawon Surabaya', 32000, 'porsi', 0, 'tidak pedas'],
                ['Ikan Bakar Jimbaran', 40000, 'porsi', 6, 'sedang'],
                ['Bakso Urat Spesial', 25000, 'porsi', 0, 'sedang'],
                ['Puding Coklat', 12000, 'cup', 3, 'tidak pedas'],
            ],
            // vendor 1: Sari Rasa (Sunda)
            [
                ['Nasi Timbel Komplit', 30000, 'porsi', 0, 'tidak pedas'],
                ['Ayam Goreng Sunda', 32000, 'porsi', 0, 'tidak pedas'],
                ['Karedok Segar', 20000, 'porsi', 0, 'pedas'],
                ['Empal Gentong', 35000, 'porsi', 0, 'sedang'],
                ['Pepes Ikan Mas', 28000, 'porsi', 0, 'sedang'],
                ['Sayur Asem Segar', 18000, 'porsi', 0, 'tidak pedas'],
                ['Sop Buntut Goreng', 55000, 'porsi', 0, 'tidak pedas'],
                ['Nasi Liwet Sunda', 25000, 'porsi', 0, 'tidak pedas'],
                ['Bandrek Hangat', 12000, 'gelas', 4, 'tidak pedas'],
                ['Surabi Manis', 10000, 'pcs', 3, 'tidak pedas'],
                ['Snack Box Premium', 25000, 'box', 2, 'tidak pedas'],
                ['Tahu Sumedang', 15000, 'porsi', 2, 'pedas'],
                ['Lotek Bandung', 22000, 'porsi', 0, 'sedang'],
                ['Batagor Kuah', 20000, 'porsi', 0, 'pedas'],
                ['Es Kelapa Muda', 15000, 'gelas', 4, 'tidak pedas'],
            ],
            // vendor 2: Berkah Jaya (Jawa Timur)
            [
                ['Rawon Spesial', 32000, 'porsi', 0, 'tidak pedas'],
                ['Rujak Cingur', 28000, 'porsi', 0, 'pedas'],
                ['Lontong Balap', 22000, 'porsi', 0, 'sedang'],
                ['Sate Kambing', 45000, 'porsi', 7, 'tidak pedas'],
                ['Nasi Campur Surabaya', 30000, 'porsi', 0, 'sedang'],
                ['Tahu Campur', 25000, 'porsi', 0, 'sedang'],
                ['Pecel Madiun', 20000, 'porsi', 0, 'pedas'],
                ['Bebek Goreng', 38000, 'porsi', 0, 'tidak pedas'],
                ['Es Daluman', 10000, 'gelas', 4, 'tidak pedas'],
                ['Klepon', 8000, 'porsi', 3, 'tidak pedas'],
                ['Snack Box Jumbo', 22000, 'box', 2, 'tidak pedas'],
                ['Nasi Krawu', 25000, 'porsi', 0, 'sedang'],
                ['Soto Lamongan', 28000, 'porsi', 0, 'tidak pedas'],
                ['Lontong Kupang', 20000, 'porsi', 0, 'tidak pedas'],
                ['Onde-Onde', 10000, 'porsi', 3, 'tidak pedas'],
            ],
            // vendor 3: Royal Feast (Western/Fusion)
            [
                ['Beef Steak Medium', 75000, 'porsi', 0, 'tidak pedas'],
                ['Chicken Cordon Bleu', 55000, 'porsi', 0, 'tidak pedas'],
                ['Caesar Salad', 35000, 'porsi', 0, 'tidak pedas'],
                ['Cream of Mushroom Soup', 28000, 'porsi', 0, 'tidak pedas'],
                ['Salmon Grilled', 85000, 'porsi', 6, 'tidak pedas'],
                ['Pasta Carbonara', 45000, 'porsi', 0, 'tidak pedas'],
                ['Lamb Rack Rosemary', 95000, 'porsi', 0, 'tidak pedas'],
                ['Risotto Truffle', 65000, 'porsi', 0, 'tidak pedas'],
                ['Mocktail Sunrise', 20000, 'gelas', 4, 'tidak pedas'],
                ['Tiramisu Cake', 30000, 'slice', 3, 'tidak pedas'],
                ['Canape Box Premium', 40000, 'box', 2, 'tidak pedas'],
                ['Fish & Chips', 42000, 'porsi', 0, 'tidak pedas'],
                ['Bruschetta Trio', 35000, 'porsi', 0, 'tidak pedas'],
                ['Chocolate Lava', 28000, 'porsi', 3, 'tidak pedas'],
                ['Fruit Infused Water', 15000, 'liter', 4, 'tidak pedas'],
            ],
            // vendor 4: Padang Bundo
            [
                ['Rendang Daging', 42000, 'porsi', 0, 'pedas'],
                ['Ayam Pop', 35000, 'porsi', 0, 'tidak pedas'],
                ['Dendeng Balado', 38000, 'porsi', 0, 'sangat pedas'],
                ['Gulai Otak', 30000, 'porsi', 0, 'sedang'],
                ['Gulai Ikan Kakap', 40000, 'porsi', 6, 'sedang'],
                ['Ayam Bakar Padang', 35000, 'porsi', 0, 'pedas'],
                ['Sambal Goreng Kentang', 20000, 'porsi', 0, 'pedas'],
                ['Nasi Padang Komplit', 35000, 'porsi', 0, 'pedas'],
                ['Teh Talua', 15000, 'gelas', 4, 'tidak pedas'],
                ['Lamang Tapai', 12000, 'potong', 3, 'tidak pedas'],
                ['Snack Padang Box', 20000, 'box', 2, 'tidak pedas'],
                ['Gulai Tunjang', 35000, 'porsi', 0, 'sedang'],
                ['Ikan Bilih Goreng', 25000, 'porsi', 6, 'tidak pedas'],
                ['Kalio Ayam', 32000, 'porsi', 0, 'sedang'],
        ...
        foreach ($vendorProfiles as $vi => $vp) {
            ...
            $vendor = Vendor::create([
                ...
                'vendor_name' => $vp['name'],
                'description' => $vp['desc'],
                'address' => 'Jl. Katering No. ' . ($vi + 1) . ', ' . $vp['city'],
                'city' => $vp['city'],
                'province' => 'Indonesia',
                'phone' => $vp['phone'],
                'whatsapp_number' => $vp['wa'],
                'email' => $vp['email'],
                'status' => 'active',
                'rating' => 0,
                'total_reviews' => 0,
        ...
        // ══════════════════════════════════════════════
        $customerNames = [
            ['Ahmad Fauzi', 'ahmad_fauzi'],
            ['Siti Nurhaliza', 'siti_nur'],
            ['Budi Santoso', 'budi_s'],
            ['Dewi Kartika', 'dewi_k'],
            ['Eko Prasetyo', 'eko_pras'],
            ['Fitri Handayani', 'fitri_h'],
            ['Gunawan Wibowo', 'gunawan_w'],
            ['Hana Pertiwi', 'hana_p'],
            ['Irfan Hakim', 'irfan_h'],
            ['Joko Widodo', 'joko_w'],
            ['Kartini Putri', 'kartini_p'],
            ['Lukman Hakim', 'lukman_h'],
            ['Maya Sari', 'maya_sari'],
            ['Nanda Pratama', 'nanda_p'],
            ['Olivia Wijaya', 'olivia_w'],
        ];
        ...
        foreach ($customers as $ci => $customer) {
            ...
            if (!is_array($vendorPicks))
                $vendorPicks = [$vendorPicks];
        ...
        $this->command->info('📐 Commission rule created (PPN 11%, Platform 10%, Vendor 89%).');

        // ══════════════════════════════════════════════
        // 10. WALLETS — untuk admin + semua vendor
        // ══════════════════════════════════════════════
        $allUsers = User::whereIn('role', ['admin', 'vendor'])->get();
        foreach ($allUsers as $u) {
            $earned = $u->isAdmin() ? rand(5000000, 20000000) : rand(1000000, 8000000);
            $withdrawn = $u->isAdmin() ? 0 : rand(0, (int) ($earned * 0.4));
            $wallet = Wallet::create([
                'user_id' => $u->id,
                'balance' => $earned - $withdrawn,
                'frozen_balance' => $u->isVendor() ? 10000000 : 0,
                'total_earned' => $earned,
                'total_withdrawn' => $withdrawn,
            ]);

            // Create wallet_transactions so charts have data
            $category = $u->isAdmin() ? 'platform_fee' : 'commission';
            $months = ['2026-02', '2026-03', '2026-04'];
            $remaining = $earned;
            foreach ($months as $i => $month) {
                $amt = ($i === count($months) - 1) ? $remaining : (int) ($earned * (rand(20, 40) / 100));
                ...
                DB::table('wallet_transactions')->insert([
                    ...
                    'category' => $category,
                    'amount' => $amt,
                    'balance_after' => $earned - $remaining,
                    'frozen_after' => $u->isVendor() ? 10000000 : 0,
                    'reference_type' => 'order',
                    'reference_id' => null,
                    'description' => $u->isAdmin() ? 'Platform fee' : 'Vendor payout',
                    'created_at' => $month . '-' . str_pad(rand(1, 28), 2, '0', STR_PAD_LEFT) . ' ' . rand(8, 18) . ':00:00',
                    'updated_at' => now(),
                ]);
            }
            ...
            if ($withdrawn > 0) {
                DB::table('wallet_transactions')->insert([
                    ...
                    'category' => 'withdrawal',
                    'amount' => $withdrawn,
                    'balance_after' => $earned - $withdrawn,
                    'frozen_after' => $u->isVendor() ? 10000000 : 0,
                    'reference_type' => 'withdrawal_request',
                    'reference_id' => null,
                    'description' => 'Penarikan dana',
                    'created_at' => '2026-04-' . str_pad(rand(10, 27), 2, '0', STR_PAD_LEFT) . ' ' . rand(8, 18) . ':00:00',
                    'updated_at' => now(),
                ]);
            }
        }
        $walletCount = $allUsers->count();
        $this->command->info("👛 {$walletCount} wallets created (admin + vendors).");
        ...
        $this->command->info('📐 1 Commission rule (PPN 11%, Platform 10%)');
        $this->command->info("👛 {$walletCount} Wallets (admin + vendor)");
        $this->command->info('═══════════════════════════════════════');
    }
}
